...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Jacky Huang"
  # s.authors            = { "Jacky Huang" => "18675574495@163.com" }
  # s.social_media_url   = "http://twitter.com/Jacky Huang"
  ...
  s.source_files  = "HYBLoopScrollView/HYBLoopScrollview/*.{h,m}"
